...
<TS version="2.1" language="en" sourcelanguage="en">
  <context>
    ...
    <message>
      ...
      <translation>&lt;p&gt;Requested capture group name &apos;%1&apos;, but it is not defined in the pattern: &lt;pre&gt;%2&lt;/pre&gt;&lt;/p&gt;</translation>
    </message>
  </context>
  <context>
    ...
    <message>
      ...
      <translation>Import only the following groups:</translation>
    </message>
    <message>
...
You can use named groups and refer to them in group list below. To name a group use: &lt;pre&gt;(?&amp;lt;myGroupName&amp;gt;\s+\d+\s+)&lt;/pre&gt;&lt;/p&gt;</source>
      <translation>&lt;p&gt;Use regular expression groups to enclose parts of the expression that you want to import. If you want to use a group that you don&apos;t want to import, use the &quot;import only following groups&quot; option below.

You can use named groups and refer to them in the group list below. To name a group, use: &lt;pre&gt;(?&amp;lt;myGroupName&amp;gt;\s+\d+\s+)&lt;/pre&gt;&lt;/p&gt;</translation>
    </message>
    <message>
