...
<TS version="2.1" language="nl" sourcelanguage="en">
  <context>
    ...
    <message>
      ...
      <translation>Voer het patroon voor de reguliere expressie in.</translation>
    </message>
    <message>
      <location filename="../regexpimport.cpp" line="169"/>
      <source>Invalid pattern: %1</source>
      <translation>Ongeldig patroon: %1</translation>
    </message>
    <message>
      <location filename="../regexpimport.cpp" line="189"/>
      <source>Requested capture index %1 is out of range.</source>
      <translation>De gevraagde capture-index %1 valt buiten het bereik.</translation>
    </message>
    <message>
      ...
      <translation>&lt;p&gt;Gevraagde naam van capturegroep &apos;%1&apos;, maar deze is niet gedefinieerd in het patroon: &lt;pre&gt;%2&lt;/pre&gt;&lt;/p&gt;</translation>
    </message>
  </context>
  <context>
...
&lt;p&gt;If you used named groups in the pattern, you can use names instead of indexes. You can mix indexes and names in this list.&lt;/p&gt;</source>
      <translation>&lt;p&gt;Voer een door komma&apos;s gescheiden lijst met capturegroepindexen in. De index 0 verwijst naar de volledige overeenkomende tekenreeks.&lt;/p&gt;
&lt;p&gt;Als u benoemde groepen in het patroon hebt gebruikt, kunt u namen gebruiken in plaats van indexen. U kunt indexen en namen in deze lijst combineren.&lt;/p&gt;</translation>
    </message>
    <message>
      <location filename="../regexpimport.ui" line="56"/>
      <source>Example: 1, 3, 4</source>
      <translation>Voorbeeld: 1, 3, 4</translation>
    </message>
    <message>
...
You can use named groups and refer to them in group list below. To name a group use: &lt;pre&gt;(?&amp;lt;myGroupName&amp;gt;\s+\d+\s+)&lt;/pre&gt;&lt;/p&gt;</source>
      <translation>&lt;p&gt;Gebruik reguliere-expressiegroepen om delen van de expressie die u wilt importeren te omsluiten. Als u een groep wilt gebruiken die u niet wilt importeren, gebruik dan de optie &quot;alleen de volgende groepen importeren&quot; hieronder.

U kunt benoemde groepen gebruiken en ernaar verwijzen in de groepslijst hieronder. Gebruik om een groep een naam te geven: &lt;pre&gt;(?&amp;lt;myGroupName&amp;gt;\s+\d+\s+)&lt;/pre&gt;&lt;/p&gt;</translation>
    </message>
    <message>
      <location filename="../regexpimport.ui" line="81"/>
      <source>Example: (\d+)\s+((\d+)\w+)\s+(\w+)</source>
      <translation>Voorbeeld: (\d+)\s+((\d+)\w+)\s+(\w+)</translation>
    </message>
  </context>
</TS>
